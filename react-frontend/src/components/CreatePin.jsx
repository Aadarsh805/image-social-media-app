    ...
    <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5">
      ...
      <div className="flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full">
        <div className="bg-secondaryColor p-3 flex flex-0.7 w-full">
          <div className="flex justify-center items-center border-2 border-dotter border-gray-300 p-3 w-full h-420">
            {loading && <Spinner />}
        ...
        <div className="flex flex-1 flex-col gap-6 lg:p-5 mt-5 w-full">
          ...
          <input
            ...
            className="outline-none text-base sm:text-lg p-2 border-b-2 border-gray-200"
          />
          <input
            type="text"
            value={destination}
